...
const timeline = [
  {
    id: 0,
    content:
      'UNITED ONE FIVE ZERO TURN LEFT HEADING TWO FOUR ZERO DESCEND ONE SIX THOUSAND',
  ...
  },
  {
    id: 1,
    content:
      'DESCEND ONE SIX THOUSAND AND UH SAY AGAIN HEADING FOR UNITED ONE FIVE ZERO',
    target: 'UAL 150',
    icon: 'img',
    src: Plane,
